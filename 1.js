...
let upload_items = () => {
    let x = '<img src="https://sun9-17.userapi.com/9qcP3gE3UA5CNdwFXLneRij2fZ9MoDUP-Dafyw/rnb9_U3KNug.jpg" style="margin: 5px; width: 25%; border-radius: 5px;">';
    ...
    for (let i = 0; i < namelist2.length; i++) {
        ...
        item += '<img src="https://sun9-17.userapi.com/9qcP3gE3UA5CNdwFXLneRij2fZ9MoDUP-Dafyw/rnb9_U3KNug.jpg" style="margin: 5px; width: 31%; border-radius: 5px;"></img>';
